...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    DListNode d=((DList)myList).newNode(item,(DList)myList , this,this.next);
   // d.myList=this.myList;
    this.next.prev=d;
    this.next=d;
    this.myList.size++;
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    DListNode d=((DList)myList).newNode(item,(DList)myList,this.prev,this); //because you donnot whether mylist is a DList, not all list is DList. myList is a list..
